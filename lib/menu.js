...
Created By : https://github.com/rendy117
Created By : https://github.com/rendy117
*/

exports.textTnC = () => {
    return `
Whatsapp : wa.me/6289531048225
Author? : Renzz
Instagram: https://instagram.com/renz_1210
Github: https://github.com/rendy117

Best regards, Rendy.`
}

const sosmed = 'https://instagram.com/renz_1210'

exports.textmenupenting = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamatt datang di Renzbot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
https://www.instagram.com/renz_1210
Berikut fitur yang dapat di gunakan pada bot ini✨

List menu penting renzbot:

Silahkan Yang ingin mendapatkan info renzbot lebih cepat ketik 
${prefix}grup
tapi gk usah keluar masuk grup ya :)

🚀 *${prefix}addbacot*
Untuk melihat bacotan member renzbot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member renzbot
...
2. *${prefix}donasi*
Untuk mendonasikan kepada rendy
Usage: Ketik */donasi*.
...
12. *${prefix}hilih*
Untuk Renz bot merubah kata hilih
Usage: Ketik */hilih* teksnya

15. *${prefix}getpic*
Untuk Renz bot maling gambar orang
...
Selamat menikmati✨
_made with_❤️ @renzbot`

}

exports.textsongmenu = (pushname) => {
   return `
Hi Kak ${pushname}👋️, selamat datang di Renzbot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
${sosmed}
Berikut fitur yang dapat di gunakan pada bot ini✨
...
exports.textmenulama = (pushname, updater) => {
 return `
Hi Kak ${pushname}👋️, selamat datang di Renzbot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Sayang Terhadap Bot ini
https://www.instagram.com/renz_1210
Berikut menu yang dapat di gunakan pada bot ini✨

*Ketik /chat* 
*Untuk Mengobrol dengan renzbot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan renzbot chatnya*

List menu:

1. *${prefix}menupenting*
Menampilkan menu penting di renzbot
Usage: ketik */menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di renzbot
Usage: ketik */menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di renzbot
Usage: ketik */mentol*
...
exports.textAdmin = () => {
    return `
⚠ [ *Admin Group Only* ] ⚠ 
Berikut adalah fitur admin grup yang ada pada ❣ *RenzBot* ❣!
...
⚠ [ *Owner Group Only* ] ⚠
Berikut adalah fitur owner grup yang ada pada ❣ *RenzBot* ❣!
🐼 *${prefix}kickall*
